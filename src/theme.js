...
const darkTheme = {
  name: "dark",
  primaryLight: color("#4038a5").lighten(0.7).toString(),
  primary: "#4038a5",
  primaryDark: "#38248b",
  ...
  linkHover: color("#FFFFFF").alpha(0.6).toString(),
  breakpoints: {
    xs: 0,
    xsm: 400,
    sm: 576,
...
const lightTheme = {
  ...
  accent: "#404fa6",
  accentDark: color("#404fa6").darken(0.08).toString(),
  accentLight: "#9fa8da",
  text: "#000000",
  textSecondary: color("#000000").alpha(0.7).toString(),
  textInvert: "#FFFFFF",
  breakpoints: {
    xs: 0,
    sm: 576,
