  ...
  return (
    <CloudWrapper opacity={hasClouds ? 1 : 0}>
      <>
        ...
        <Cloud top={100} speed={100} scale={1.1} zIndex={9999} delay={-5} />
        <Cloud top={150} speed={170} scale={1.2} delay={-120} />
        <Cloud top={230} speed={140} scale={0.9} delay={-80} zIndex={9999} />
        <Cloud top={270} speed={80} scale={0.6} delay={-30} zIndex={9999} />
